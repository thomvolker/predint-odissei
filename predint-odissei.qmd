...
::: {.fragment }
$$
y \pm t_{\alpha/2, n-p}\sqrt{\sigma^2(1+ x^T(X^TX)^{-1}x)}
$$
:::
...
## Pooling the prediction intervals (skip deze)
...
- Split in lage/hoge r2
- Split in lage/hoge rho

## Results (conditional, ntrain = 500, miss = both)
